...
7. If you don't see the VSCode notification to "Reopen in Container", you can run the command from the Command Palette (F1) or quick actions Status bar item. 
