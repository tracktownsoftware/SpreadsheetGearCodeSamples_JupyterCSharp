...
- [Clone this repo and open in your local VSCode editor (Install all requirements)](#clone-this-repo-and-open-in-your-local-vscode-editor-install-all-requirements)

## Clone this repo and open in your local VSCode editor (Install all requirements) ##

*There is no need to do install this list of requirements if viewing code samples in Github Codespaces or a local DevContainer.*
